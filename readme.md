 ![](https://user-images.githubusercontent.com/18350557/176309783-0785949b-9127-417c-8b55-ab5a4333674e.gif)Меня зовут L1bz!
============================================================================================================================

Fullstack Developer
-------------------

Изучия програмирования с 2021 года, начинал писать на python, пробывал себя в телеграм ботах pytelebot и aiogram. Для изучения django попробывал в web(frontend), позже перешел на Java и начал изучать Spring. Нередко приходится использовать sql и postegsql. Недавно начал учить парсинг сайтов, react, docker.
